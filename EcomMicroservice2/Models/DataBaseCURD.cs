        ...
        public List<ProductDetailsClass> GetProductDetailsAll(string connectionString,Int32 Family,Int32 Class,Int32 Commodity,string Color,string Brand)
        {
            ...
            try{
                ...
                {  
                    ...
                    sbQuery.Append("  ORDER BY FAMILY, CLASS, COMMODITY , SKU.STYLE_ITEM, SKU.ITEM_NUMBER, COMMODITY_NAME, BRAND, SKU_ATTRIBUTE_VALUE1 AS SIZE, SKU_ATTRIBUTE_VALUE2 AS COLOUR, LIST_PRICE, DISCOUNT, IN_STOCK, PRICE_EFFECTIVE_DATE, SKU.DESCRIPTION,SKU.LONG_DESCRIPTION ");
