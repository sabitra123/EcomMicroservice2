...
namespace EcomMicroservice2.Models
{
    public static class QueryStringClass
    {
        ...
        public static string getDistinctBrandProduct = "SHOW COLUMNS AS BRAND FROM XXIBM_PRODUCT_SKU"; //"select DISTINCT BRAND from XXIBM_PRODUCT_STYLE  ORDER BY BRAND";
